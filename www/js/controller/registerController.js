...
ionicModule.controller('RegisterCtrl', function ($scope, $ionicHistory, $rootScope, services, popups, $location, images, $ionicPopup, $ionicModal) {
    ...
    function validUser() {
        ...
        if ($scope.userRegiter.fullname == undefined || $scope.userRegiter.fullname == '') {
            ...
            return false
        } else if ($scope.userRegiter.title == undefined || $scope.userRegiter.title == '') {
            popups.showAlert("Please enter a valid Phone Number");
            return false
        } else if ($scope.userRegiter.degree == undefined || $scope.userRegiter.degree == '') {
            popups.showAlert("Please enter a valid Phone Number");
            return false
        } else if ($scope.userRegiter.affiliation == undefined || $scope.userRegiter.affiliation == '') {
            popups.showAlert("Please enter a valid Phone Number");
            return false
